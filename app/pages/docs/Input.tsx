    ...
    <div className="prose prose-invert max-w-none space-y-12">
      <section className="space-y-4">
        <div className="mb-4 inline-flex rounded-2xl bg-purple-500/10 p-4">
          <LogIn className="size-8 text-purple-400" />
        </div>
        <h1 className="text-3xl font-bold text-white tracking-tight">5. Input</h1>
        <p className="text-lg leading-relaxed text-gray-400 max-w-2xl">
          Use the <code className="text-purple-400 font-mono">get()</code> keyword to receive 
