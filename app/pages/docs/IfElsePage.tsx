  ...
  return (
    <div className="prose prose-invert max-w-none space-y-12">
      <section className="space-y-4">
        ...
        <h1 className="text-3xl font-bold text-white tracking-tight">9. If-Else</h1>
        <p className="text-lg leading-relaxed text-gray-400 max-w-2xl">
          Use <code className="text-purple-400 font-mono">else</code> to provide an 
          alternative block of code if the initial condition is false.
        </p>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-xl border border-white/5 bg-black/30 p-4">
          ...
          <code className="text-green-400 text-sm font-mono">Pass</code>
        </div>
      </section>

      <div className="pt-12 border-t border-white/5">
        <Link 
          to="/docs/loops-overview" 
